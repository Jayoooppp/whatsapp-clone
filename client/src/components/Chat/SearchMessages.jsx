...
function SearchMessages() {
  const [{ currentChatUser, messages }, dispatch] = useStateProvier();
      ...
      <div className="flex flex-col w-full h-full">
        {
          searchedMessages.map((message) => (
            <div className="flex cursor-pointer flex-col justify-center w-full hover:bg-background-default-hover px-5 border-b-[0.1px] border-secondary py-5" >
